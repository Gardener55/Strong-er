...
class ExerciseDatabase: ObservableObject {
    ...
    func searchExercises(_ query: String) -> [Exercise,
            Exercise(
                ...
                category: .strength,
                muscleGroups: [.unspecified],
                equipment: .unspecified,
                description: "Placeholder: Please fill in a description for this exercise.",
                instructions: ["Placeholder: Please add instructions for this exercise."],
                difficulty: .intermediate,
                exerciseType: .unspecified,
                targetMuscleGroup: .unspecified
            ),
            Exercise(
